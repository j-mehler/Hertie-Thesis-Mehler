...
The analytical approach includes independent samples t-tests and chi-square-tests to evaluate differences in the definitions' properties between academics and non-academics, and several multinomial logistic regressions to examine the role of an academic background in shaping the personal hate speech definition. At the end, academic background will also be analyzed as a moderator of certain variable compositions. 
