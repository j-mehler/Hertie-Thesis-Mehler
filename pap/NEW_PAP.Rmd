---
title: "How does formal education shape people's conceptions of hate speech on social media? - Pre Analysis Plan"
...
Amidst the growing concern over hate speech online and its amplification via social media and generative AI, discourse on the trade-off between freedom of speech and protection of vulnerable societal groups has once again received great attention. But how inclusive is the discussion? 

Participation in political discourse was and is also a question of education. To investigate this within the phenomenon of hate speech on social media, the following research question is addressed: How does formal education shape conceptions of hate speech?

Research by Heijden and Verkuyten [-@heijden2020] on educational attainment and political attitudes suggests that higher educational attainment goes hand in hand with more sophisticated, but also more ideologically defined political knowledge and views. It is therefore hypothesized that an academic level of education leads to more sophisticated definitions of hate speech (H1) and that academic respondents' definitions of hate speech are more politically defined than those of non-academics (H2).
...
The analytical approach includes independent samples t-tests and chi-square-tests to evaluate differences in the definitions' properties between academics and non-academics, and several multinomial logistic regressions to examine the role of an academic background in shaping the personal hate speech definition. At the end, academic background will also be analyzed as a moderator of certain variable compositions. The analysis will control for variables such as gender, age, political interest, and empathy to ensure a comprehensive understanding of the educational influence. Stratified analyses will break down the data across different national and ideological contexts.
...
* "Politisierung" -> how easy it is to say which political spectrum they are in / where on the scale 0-10 they are (siehe Polarisierungspaper Predictiveness Analysis for Political Affiliation: #Polar Scores: Measuring partisanship using social media content (Hemphill, Culotta, and Heston 2016))
...
-	Political interest (measured with four levels and collapsed into low/intermediate/high for a meaningful distribution)
-	Empathy (first principal component of responses to three topic-specific items, used as composite measure of empathy in further analysis. One or two missing values in the three items were immputed with the mean of the existing answers)
...
**1. Predictiveness (Predictability) Analysis for Political Affiliation:**
