...
model_interaction(data, "leftright_cat", "text_length")
...
# plot_scatter(data, "empathy_pc", "leftright_pred_error")
# model_interaction(data, "empathy_pc_cat", "leftright_pred_error")
```
...
#model_interaction <- function(data, var1, var2) {
#  # Construct the formula as a string
#  formula_str <- paste0(var2, " ~ educ_cat:", var1, " + gender + age_cat + #commitment_log2")
#  
#  # Convert the string to a formula
#  formula_obj <- as.formula(formula_str)
#  
...
#model_interaction(data, "polinterest_cat_3", "readability_score")
#
##åplot_scatter(data, "polinterest", "leftright_pred_error")
##åmodel_interaction(data, "polinterest", "leftright_pred_error")
##åmodel_interaction(data, "polinterest_cat_3", "leftright_pred_error")
```
...
#
#plot_scatter(data, "empathy_pc", "leftright_pred_error")
#model_interaction(data, "empathy_pc", "leftright_pred_error")
#model_interaction(data, "empathy_pc_cat", "leftright_pred_error")
```
