...
Main components for cluster 1 are "attack (75%) against a person (72%)"
...
Main components for cluster 2 are "offensive (17%), hateful (27%), dehumanization (20%), content  against a group of people (57%) because of their race (20%)"
...
Cluster 3 is about nonsense (100%) and other features from the section "other", mostly deniying existence, importance, or any objective characteristics of hate speech.
...
Cluster 4 has a focus on incitement (100%), as well as a description of person (32%) AND people (63%) as scope of hate speech. 

-> Would be interesting to look at some text examples of these definitions compared to the other clusters.
