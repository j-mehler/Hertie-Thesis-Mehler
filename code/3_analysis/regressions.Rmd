...
model_text_length <- lm(text_length ~ academic_status + gender + age_cat + minority_cat + polinterest_cat_3 + empathy_pc + exp_hate_speech + exp_hostile_engagement, data = data)
