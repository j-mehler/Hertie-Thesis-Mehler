...
model_interaction <- function(data, var1, var2) {
  ...
  formula_str <- paste0(var2, " ~ academic_status:", var1, " + gender + age_cat + total_minutes_log2")
...
#åplot_scatter(data, "polinterest", "leftright_pred_score")
#åmodel_interaction(data, "polinterest", "leftright_pred_score")
#åmodel_interaction(data, "polinterest_cat_3", "leftright_pred_score")
```
