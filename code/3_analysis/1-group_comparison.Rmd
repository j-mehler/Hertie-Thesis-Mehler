...
p <- ggpairs(data,  # Data frame
             ...
             upper = list(continuous = wrap("cor", size = 6),
                          continuous = "smooth"),
             diag = list(mapping = aes(color = academic_status)),
             lower = list(
              mapping = aes(color = academic_status),
                          continuous = "smooth",
                          combo = "facetdensity")
 ) 
...
ggsave("ggpairs.png", path = here("figures"), width = 8, height = 10)
```
...
data_cluster %>%
  ...
  scale_fill_manual(values = c("academic" = "orange", "non-academic" = "skyblue")) +
  labs(title = "Cluster Distribution by Academic Status", 
       x = "Cluster", 
       y = "Frequency",
